...
export const deleteStudent = (id: string)                    => fetch(`/api/students/${id}`, { method: 'DELETE' }).then(r => handle<{ message: string }>(r));
...
export const deleteCourse = (id: string)                    => fetch(`/api/courses/${id}`, { method: 'DELETE' }).then(r => handle<{ message: string }>(r));
...
export const dropEnrolment   = (id: string)               => fetch(`/api/enrolments/${id}`, { method: 'DELETE' }).then(r => handle<{ message: string }>(r));
